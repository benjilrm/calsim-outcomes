...
process_all_scenarios = function(demand_folder, delivery_folder, crosswalk, output_base = "Outputs") {
  ...
  if (!is.null(output_base)) {
    ...
    write.csv(tier_matrix, file.path(tier_dir, "20260313_climate_scenarios_tiers.csv"), row.names = F)}
...
results = process_all_scenarios(
  demand_folder = "Inputs/Climate scenarios/Demands",
  delivery_folder = "Inputs/Climate scenarios/Deliveries",
  crosswalk = crosswalk,
  output_base = "Outputs")
```
