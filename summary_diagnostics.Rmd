...
read.csv("Outputs/Tier summaries/all_scenarios_tier_matrix_alt5.csv")%>%
  ...
  reframe(prop = n()/total_n)%>%
  unique()%>%
  filter(scenario_id %in% c("s0020", "s0021", "s0023", "s0024"))%>%
  ...
  scale_x_discrete(labels = c(
    "s0020" = "Baseline",
    "s0021" = "Current operations \n without TUCPs", 
    "s0023" = "2024 USBR BiOps \n without TUCPs",
    "s0024" = "2024 USBR BiOps"))
...
scenarios <- c("s0020", "s0021", "s0023", "s0024")
...
all_data%>%
  ...
  mutate(dwuc = factor(dwuc, 
                       ...
                       labels = c("Davis / Woodland", "Huron / Avenal / Coalinga", "Metropolitan", "Napa / St. Helena / Calistoga"))) %>%
